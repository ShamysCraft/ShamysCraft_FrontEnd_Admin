    ...
    return (
        <div className={classes.sidebar}>
            ...
            <ul className={classes.sidebarList}>
                <li className={classes.row} ><Storefront /><Link style={{ textDecoration: 'none' }} to='/adminDashboard'><Typography className={classes.title}>Dashboard</Typography></Link></li>
                ...
                <li className={classes.row} ><HourglassEmpty /><Link style={{ textDecoration: 'none' }} to='/ordersReceived'><Typography className={classes.title}>Orders Received</Typography></Link></li>
